...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public boolean insertData(String name,  int result, double latitude, double longitude){
    ...
    public void updateData(String id, String name, int result, double latitude, double longitude) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(KEY_NAME,name);
