...
public class MemoryGameService extends Service implements SensorEventListener {
    ...
    private void initThread() {
        handlerThread = new HandlerThread(com.spaceintruders.h2_Memory_Game.MemoryGameService.class.getSimpleName());
        handlerThread.start();
    ...
    class SensorBind extends Binder {
        private com.spaceintruders.h2_Memory_Game.MemoryGameService theService;
